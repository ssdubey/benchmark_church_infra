...
#client=${3}
#size=${4}
docker exec -i ${container} cqlsh -f cmdfile; ./script_set_span.sh -c set_span -h ${hosts} -r 8020 -f get -n ${client} -s ${size}; ./script_mix_span.sh -c mix_span -h ${hosts} -r 8020 -n ${client} -s ${size};
